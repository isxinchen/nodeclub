...
var getMessageRelations = exports.getMessageRelations = function (message, callback) {
  if (message.type === 'answer' || message.type === 'answer2' || message.type === 'at') {
    var proxy = new EventProxy();
    proxy.fail(callback);
    proxy.assign('author', 'question', 'answer', function (author, question, answer) {
    ...
    Answer.getAnswerById(message.answer_id, proxy.done('answer'));
  } else {
